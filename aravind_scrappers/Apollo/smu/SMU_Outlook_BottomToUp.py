...
class smu:
    ...
    def extract_data(self, browser):
        data_writer = csv.writer(open("smu_bottop_to_up.csv", "wb"))
        ...
        try:
            while dir_item:
                ...
                for a in range(num):
                    ...
                    try:
                        browser.find_element_by_xpath("/descendant::span[@class='_pe_i _pe_C'][span[contains(text(),'"+str(name).strip()+"')]][last()]/preceding::span[@class='_pe_i _pe_C'][1]/span").click()
                        time.sleep(5)
                    except:
                        pass
        except:
